...
function Sidebar({ setComponent }) {
  ...
  return (
    <>
      ...
      >
        <CiMenuBurger className="text-3xl text-gray-700 cursor-pointer" />
      </div>
      <div
        className={`w-64 h-full shadow-lg fixed top-0 left-0 bg-gray-100 transition-transform duration-300 transform sm:translate-x-0 ${
      ...
      >
        ...
        <div className="text-center py-8 bg-gradient-to-b from-blue-300 to-blue-500 text-white">
          <p className="text-xl font-semibold">{profile?.user?.name}</p>
        </div>
        <ul className="space-y-4 mt-8 mx-6">
          <button
            onClick={() => handleComponents("My Blogs")}
            className="w-full px-4 py-2 text-sm font-semibold bg-blue-300 rounded-lg hover:bg-blue-600 shadow transition duration-300"
          >
            MY BLOGS
          </button>
          <button
          ...
          <button
            onClick={() => handleComponents("Manage Courses")}
            className="w-full px-4 py-2 text-sm font-semibold bg-blue-300 rounded-lg hover:bg-blue-600 shadow transition duration-300"
          >
            Manage Courses
          </button>
          ...
          <button
            ...
            className="w-full px-4 py-2 text-sm font-semibold bg-red-500 rounded-lg hover:bg-red-600 shadow transition duration-300"
          >
            LOGOUT
          </button>
        </ul>
